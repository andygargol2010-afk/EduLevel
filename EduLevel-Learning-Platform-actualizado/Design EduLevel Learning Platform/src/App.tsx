...
function setPageMetadata(subject: Subject | null, level: Level | null) {
  ...
  const description = subject && level
    ...
    : "Tests interactivos para practicar Matemáticas, Historia y Lengua y Gramática por nivel.";
...
const formulaSheets: FormulaSheet[] = [
  {
    ...
    subject: "Matemáticas", color: "#10B981", bg: "#ECFDF5", icon: "📐",
    items: ["Fórmula cuadrática: x = (−b ± √(b²−4ac)) / 2a", "Diferencia de cuadrados: a²−b² = (a+b)(a−b)", "Binomio de Newton: (a+b)ⁿ = Σ C(n,k)·aᵏ·bⁿ⁻ᵏ", "Logaritmos: logₐ(xy) = logₐx + logₐy"],
  },
  {
    title: "Cronología — Historia Moderna",
    subject: "Historia", color: "#F59E0B", bg: "#FFFBEB", icon: "🏛️",
    items: ["1492 — Descubrimiento de América", "1517 — Reforma Protestante de Lutero", "1789 — Revolución Francesa", "1848 — Primavera de los Pueblos"],
  },
  {
    title: "Figuras Retóricas Clave",
    subject: "Gramática", color: "#7C3AED", bg: "#F5F3FF", icon: "📝",
    items: ["Metáfora: comparación sin 'como'", "Hipérbole: exageración expresiva", "Anáfora: repetición al inicio del verso", "Ironía: decir lo contrario de lo que se piensa"],
  },
  {
    title: "Geometría Analítica",
    subject: "Matemáticas", color: "#10B981", bg: "#ECFDF5", icon: "📐",
    items: ["Distancia entre puntos: d = √[(x₂−x₁)²+(y₂−y₁)²]", "Punto medio: M = ((x₁+x₂)/2, (y₁+y₂)/2)", "Pendiente: m = (y₂−y₁)/(x₂−x₁)", "Ecuación recta: y − y₁ = m(x − x₁)"],
  },
];

const homeStats = [
  { value: "18", label: "Tests disponibles" },
  { value: "90", label: "Preguntas únicas" },
  { value: "6", label: "Materias" },
...
const articleCards = [
  { title: "Cómo estudiar matemáticas para exámenes", meta: "Matemáticas · 5 min de lectura" },
  { title: "Guía para mejorar en gramática y redacción", meta: "Gramática · 6 min de lectura" },
  { title: "Qué estudiar para historia en selectividad", meta: "Historia · 7 min de lectura" },
] as const;
...
const faqItems = [
  { q: "¿Cuánto tiempo debo dedicar a estudiar cada día?", a: "Lo ideal es combinar 20 a 40 minutos de práctica concentrada con repaso de conceptos básicos y un test corto para consolidar." },
  { q: "¿Qué materia tiene más peso en los exámenes?", a: "Depende del tipo de prueba, pero en la mayoría de casos una buena base en matemáticas, lenguaje y comprensión lectora suele marcar una gran diferencia." },
  { q: "¿Cómo mejorar en simulacros?", a: "Haz simulacros en condiciones reales, revisa errores, identifica patrones y repite los temas que te cuestan para avanzar sin frustrarte." },
] as const;
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 mb-8">
            <div className="text-6xl font-black mb-2" style={{ color: config.color }}>
              {pct}%
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 mb-8 text-left">
            ...
            <h3 className="text-xl font-black text-slate-800 mb-2">Siguiente paso recomendado</h3>
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-2 mb-6 text-sm">
          ...
          <span className="text-slate-300">/</span>
          <span className="font-semibold" style={{ color: config.color }}>{levelLabel}</span>
        </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              ...
              <div>
                ...
                <h1 className="text-xl font-black text-slate-800">{config.label}</h1>
        ...
        <div className="px-6 pt-6 pb-4 flex items-start justify-between gap-3" style={{ background: sheet.bg }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-lg font-black text-slate-800">{sheet.title}</h2>
            </div>
          </div>
          <button
            onClick={onClose}
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-[1440px] mx-auto px-4 lg:px-8">
          <div className="flex items-center h-16 gap-6">
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              ...
              <span className="text-lg font-black text-slate-800 tracking-tight">EduLevel</span>
            </div>
              ...
              {mainNav.map((item) =>
                item.href ? (
                  <a
                    key={item.label}
                    href={item.href}
                    className="px-4 py-2 rounded-lg text-sm font-semibold text-slate-600 transition-all hover:text-slate-900 hover:bg-slate-100"
                  >
                    {item.label}
                  </a>
                ) : (
      ...
      {activeTab === "inicio" && (
        <main>
          {/* Hero */}
          <section className="max-w-[1440px] mx-auto px-4 lg:px-8 pt-14 pb-10 text-center">
            <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 text-blue-700 text-xs font-bold px-4 py-2 rounded-full mb-6 uppercase tracking-wider">
              🎓 Plataforma de Aprendizaje Interactivo
            </div>
            <h1 className="text-4xl md:text-6xl font-black text-slate-900 leading-tight mb-5 max-w-3xl mx-auto">
              Practica, aprende y{" "}
            ...
            {/* Stats row */}
            <div className="flex items-center justify-center gap-8 flex-wrap text-center mb-14">
              {homeStats.map((s) => (
                <div key={s.label}>
          ...
          <section aria-labelledby="aprendes" className="max-w-[1440px] mx-auto px-4 lg:px-8 pb-8">
            <div className="bg-white border border-slate-200 rounded-3xl px-6 py-8 shadow-sm">
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-blue-600 mb-3">Qué aprenderás</p>
              <h2 id="aprendes" className="text-2xl md:text-3xl font-black text-slate-900 mb-4">
          ...
          <section className="max-w-[1440px] mx-auto px-4 lg:px-8 pb-8">
            <div className="grid gap-4 md:grid-cols-4">
              {[
                { value: "90", label: "preguntas disponibles" },
                { value: "Gratis", label: "para empezar" },
                { value: "3x", label: "más motivación con rutinas" },
          ...
          <section className="max-w-[1440px] mx-auto px-4 lg:px-8 pb-16" aria-labelledby="materias">
            <div className="mb-8">
              ...
              <h2 id="materias" className="text-2xl font-black text-slate-800 mb-2">Elige una materia</h2>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <h3 className="text-xl font-black text-slate-800 mb-1">{cfg.label}</h3>
          ...
          <section id="articulos" aria-labelledby="articulos-titulo" className="max-w-[1440px] mx-auto px-4 lg:px-8 pb-16">
            <div className="mb-6">
              ...
              <h2 id="articulos-titulo" className="text-2xl font-black text-slate-800 mb-2">Guías y recursos para estudiar mejor</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {articleCards.map((article) => (
                <article key={article.title} className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
          ...
          <section aria-labelledby="guias-por-nivel" className="max-w-[1440px] mx-auto px-4 lg:px-8 pb-16">
            <div className="mb-6">
              ...
              <h2 id="guias-por-nivel" className="text-2xl font-black text-slate-800 mb-2">Elige tu nivel y empieza a practicar con estructura</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {guideCards.map((guide) => (
                <article key={guide.level} className={`border rounded-2xl p-5 bg-white shadow-sm ${guide.accent}`}>
                  ...
                  <h3 className="text-xl font-black text-slate-800 mb-2">{guide.level}</h3>
          ...
          <section aria-labelledby="faq-educativa" className="max-w-[1440px] mx-auto px-4 lg:px-8 pb-16">
            <div className="mb-6">
              ...
              <h2 id="faq-educativa" className="text-2xl font-black text-slate-800 mb-2">Todo lo que suele preguntarse antes de empezar</h2>
            </div>
          ...
          <section aria-labelledby="retencion" className="max-w-[1440px] mx-auto px-4 lg:px-8 pb-16">
            <div className="mb-6">
              ...
              <h2 id="retencion" className="text-2xl font-black text-slate-800 mb-2">Mantén la constancia y mejora cada semana</h2>
            </div>
          ...
          <section className="max-w-[1440px] mx-auto px-4 lg:px-8 pb-16" aria-labelledby="explora-contenido">
            <div className="mb-6">
              ...
              <h2 id="explora-contenido" className="text-2xl font-black text-slate-800">Simulacros, fórmulas y guías para cada etapa</h2>
            </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                <div className="flex items-center justify-between mb-5">
                  <div>
                    ...
                    <h3 className="text-lg font-black text-slate-800">Tests destacados</h3>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                <div className="flex items-center justify-between mb-5">
                  <div>
                    ...
                    <h3 className="text-lg font-black text-slate-800">Cheat sheets escaneables</h3>
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    <div key={sheet.title} className="p-3 rounded-xl bg-slate-50 border border-slate-100 hover:bg-violet-50 hover:border-violet-100 transition-all cursor-pointer">
        ...
        <main className="max-w-[1440px] mx-auto px-4 lg:px-8 py-12">
          <nav aria-label="Breadcrumb" className="mb-5 text-sm text-slate-500">
            <ol className="flex flex-wrap items-center gap-2">
              <li><button onClick={() => setActiveTab("inicio")} className="text-blue-600 hover:text-blue-800 font-medium">Inicio</button></li>
              <li>/</li>
              <li aria-current="page" className="text-slate-700 font-medium">Simulacros</li>
            </ol>
          </nav>
          <div className="mb-8">
            <h1 className="text-3xl font-black text-slate-900 mb-2">Simulacros de Examen</h1>
        ...
        <main className="max-w-[1440px] mx-auto px-4 lg:px-8 py-12">
          <nav aria-label="Breadcrumb" className="mb-5 text-sm text-slate-500">
            <ol className="flex flex-wrap items-center gap-2">
              <li><button onClick={() => setActiveTab("inicio")} className="text-blue-600 hover:text-blue-800 font-medium">Inicio</button></li>
              <li>/</li>
              <li aria-current="page" className="text-slate-700 font-medium">Fórmulas</li>
            </ol>
          </nav>
          <div className="mb-8">
            <h1 className="text-3xl font-black text-slate-900 mb-2">Fórmulas & Machetes</h1>
        ...
        <main className="max-w-[1440px] mx-auto px-4 lg:px-8 py-12">
          <nav aria-label="Breadcrumb" className="mb-5 text-sm text-slate-500">
            <ol className="flex flex-wrap items-center gap-2">
              <li><button onClick={() => setActiveTab("inicio")} className="text-blue-600 hover:text-blue-800 font-medium">Inicio</button></li>
              <li>/</li>
              <li aria-current="page" className="text-slate-700 font-medium">Guías</li>
            </ol>
          </nav>
          <div className="mb-8">
            <h1 className="text-3xl font-black text-slate-900 mb-2">Guías de Estudio</h1>
            <p className="text-slate-500">Planes de estudio estructurados para dominar cada materia a tu ritmo.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { key: "matematicas", subject: "Matemáticas", icon: "📐", color: "#10B981", bg: "#ECFDF5", border: "#6EE7B7", weeks: 8, topics: ["Álgebra básica", "Funciones", "Trigonometría", "Cálculo diferencial", "Estadística"] },
              { key: "historia", subject: "Historia", icon: "🏛️", color: "#F59E0B", bg: "#FFFBEB", border: "#FCD34D", weeks: 6, topics: ["Prehistoria y Edad Antigua", "Edad Media", "Renacimiento y Modernidad", "Revolución Industrial", "Historia Contemporánea"] },
              { key: "gramatica", subject: "Gramática", icon: "📝", color: "#7C3AED", bg: "#F5F3FF", border: "#C4B5FD", weeks: 5, topics: ["Morfología y Sintaxis", "Ortografía y Puntuación", "Tipos de texto", "Literatura española", "Comentario crítico"] },
            ].map((guide) => (
              <div key={guide.subject} className="bg-white rounded-2xl border overflow-hidden hover:shadow-md transition-all" style={{ borderColor: guide.border }}>
                <div className="p-6" style={{ background: guide.bg }}>
                  ...
                  <h3 className="text-xl font-black text-slate-800 mb-1">{guide.subject}</h3>
                  <span className="text-xs font-bold" style={{ color: guide.color }}>Plan de {guide.weeks} semanas</span>
                </div>
                <div className="p-6">
        ...
        <div className="rounded-3xl border border-blue-200 bg-gradient-to-r from-blue-600 via-blue-700 to-violet-700 p-8 text-white shadow-lg shadow-blue-200/60">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-black mb-2">¿Listo para empezar tu siguiente prueba?</h2>
      ...
      <section className="max-w-[1440px] mx-auto px-4 lg:px-8 py-16">
        <div className="mb-8 text-center">
          ...
          <h2 className="text-3xl font-black text-slate-900">Aprender con estructura, no con ansiedad</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-12">
          {[
            ...
            <div key={item.step} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
              <div className="w-10 h-10 bg-blue-100 text-blue-700 rounded-xl flex items-center justify-center text-sm font-black mb-4">{item.step}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="text-lg font-black text-white tracking-tight">EduLevel</span>
              </div>
            ...
            <div>
              <h4 className="text-xs font-bold text-slate-300 uppercase tracking-widest mb-4">Plataforma</h4>
...
export default function App() {
  ...
  const syncRoute = useCallback(() => {
    const match = window.location.pathname.match(/^\/tests\/(matematicas|historia|gramatica|geografia|fisica|quimica)\/(basico|intermedio|avanzado)\/?$/);
    if (match) {
  ...
  const handleStartQuiz = useCallback((subject: Subject, level: Level) => {
    ...
    setView("quiz");
    window.history.pushState({}, "", testPath(subject, level));
    window.scrollTo({ top: 0, behavior: "smooth" });
  }, []);
